...
# **11. 画 4 组柱子**
plt.bar(x_values - 1.5 * bar_width, df_input_itx_top50["fee"] / 1e12, width=bar_width, color=color_input_itx, label="Input ITX")
plt.bar(x_values - 0.5 * bar_width, df_onchain_itx_top50["fee"] / 1e12, width=bar_width, color=color_onchain_itx, label="On-Chain ITX")
plt.bar(x_values + 0.5 * bar_width, df_input_ctx_top50["fee"] / 1e12, width=bar_width, color=color_input_ctx, label="Input CTX")
plt.bar(x_values + 1.5 * bar_width, df_onchain_ctx_top50["fee"] / 1e12, width=bar_width, color=color_onchain_ctx, label="On-Chain CTX")
